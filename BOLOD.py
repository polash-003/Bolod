#---------------------[ INFO ]---------------------#
#JOIN : https://www.facebook.com/profile.php?id=100093064795809
#JOIN : https://www.facebook.com/profile.php?id=10009306479580907
#---------------------[MODULES ]---------------------#
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mPASA HACKER SAAD VAI\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
